  ...
  return (
    <section id="projects" className="my-20">
      <h2 className="text-black dark:text-white mb-6 text-3xl md:text-4xl lg:text-5xl font-medium leading-tight">
        Explorez Nos
        <span className="block text-[#7A7FEE] dark:text-[#7A7FEE]">Derniers Projets</span>
      </h2>
      <p className="mb-12 max-w-2xl text-gray-700 dark:text-gray-300">
        De l'automatisation alimentée par l'IA aux marketplaces personnalisées, notre travail aide les entreprises à évoluer plus intelligemment. Découvrez certaines des plateformes, outils et solutions que nous avons créés pour nos clients et nous-mêmes.
      </p>
